                ...
                <div class="card-body">
                    <h5 class="card-title">Ingeniería en Sistemas
                        ...
                        <p class="card-text">Director y administrador de su propia empresa de consultora,
                            ...
                            Interner.
                            Un Ingeniero en Sistemas en un Desarrolador de software.
                        </p>
                    ...
                    <img src="img/estudiantes-3.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                            ...
                            <p class="card-text">Director y administrador de su propia empresa de consultorías
                                ...
                                gestión, formulación y evaluación de proyectos.</p>
                            <a href="#" class="btn btn-primary">Go somewhere</a>
                        </div>
                </div>
            </div>
    ...
    <div class="row mt-3">
        <div class="col col-md-6" >
            <figure>
                ...
                <iframe class="card" style="width:500px; height:290px;" src="https://www.youtube.com/embed/OpnWTKYTQ8Q" frameborder="0" 
